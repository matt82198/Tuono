# BUILDLOG.md — Tuono Build History
...
**Next:** User in-game verdict on v0.2.3 (`/tuono apitest`) → M4 completion (party-HP if legal) → M5 ship (CurseForge).
