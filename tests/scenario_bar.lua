...
for _, f in ipairs({
  "Tuono/Core.lua", "Tuono/data/rules.lua", "Tuono/StateTracker.lua",
  "Tuono/AssistReader.lua", "Tuono/Rotation.lua",
  "Tuono/IntelligenceLayer.lua", "Tuono/Display.lua",
  "Tuono/Config.lua", "Tuono/ApiTest.lua"
}) do assert(loadfile(f))("Tuono", Tuono) end
